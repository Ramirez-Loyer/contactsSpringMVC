...
public class ContactsSpringMvcApplication implements CommandLineRunner {

	private static final Logger logger = LoggerFactory.getLogger(ContactsSpringMvcApplication.class);
	...
	@Autowired
	public ContactsSpringMvcApplication (ContactRepository contactRepository) {
		this.contactRepository = contactRepository;
	}

	public static void main(String[] args) {

		SpringApplication.run(ContactsSpringMvcApplication.class, args);
	}
